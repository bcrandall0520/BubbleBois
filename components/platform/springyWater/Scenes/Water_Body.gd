...
@onready var water_spring = preload("res://components/platform/springyWater/Scenes/Water_Spring.tscn")
...
@onready var splash_particle = preload("res://components/platform/springyWater/Scenes/splash_particles.tscn")
